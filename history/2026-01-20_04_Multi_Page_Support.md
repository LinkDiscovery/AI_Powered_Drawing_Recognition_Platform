...
## 4. 버그 수정 (Bug Fixes) - 2026-01-20 16:35
*   **이슈:** 대시보드(`UserDashboard.tsx`)에서 파일을 열 때, 기존에 저장된 태그들의 `page` 정보를 매핑하지 않아 모든 태그가 1페이지로 겹쳐 보이는 현상 발생.
*   **수정:** `frontendBBoxes` 매핑 로직에 `page: b.page || 1` 추가하여 해결함.
